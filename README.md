...
A collection of GitHub Actions for security analysis and risk assessment of infrastructure and application code.
...
_Generated from action metadata via `./scripts/generate-action-list.sh` to keep docs and release notes in sync._

## 🚀 Quick Start

1. **Choose an action** from the [Available Actions](#-available-actions) table above
2. **Read the action's documentation** for detailed usage instructions
3. **Add the action to your workflow** following the examples in each action's README
